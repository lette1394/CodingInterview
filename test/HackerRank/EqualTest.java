...
import static HackerRank.Equal.equal;
...
public class EqualTest {
    ...
    public void main() throws Exception {
        int[] arr = new int[] {2, 2, 3, 7, 9, 11, 11, 15};
        assertEquals(14, equal(arr,2));

        int[] arr2 = new int[] {2, 2, 3, 7};
        assertEquals(2, equal(arr2,2));

        int[] arr3 = new int[] {2, 5, 5, 5, 5, 5};
        assertEquals(6, equal(arr3,2));
    }

    @Test
    public void boundary() throws Exception {
        int[] arr = new int[] {1,1,1,1,1,1,1,1,1,11};
        assertEquals(2, equal(arr,1));

        int[] arr2 = new int[] {2, 2, 3, 7};
        assertEquals(2, equal(arr2,2));

        int[] arr3 = new int[] {};
        assertEquals(0, equal(arr3,0));
    }
    ...
    public void simulate() {
        ...
        assertEquals(Arrays.asList(10605,
                8198,
                18762,
                16931,
                5104), answer(input));
    ...
    List<Integer> answer(String input) {
